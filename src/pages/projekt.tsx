    ...
    <Box>
      ...
      <Box>
        ...
        >
          ...
          <Box>
            <h1>
              <span style={{ color: '#BC27F6' }}>Die Plattform </span> <br />{' '}
        ...
        <Box sx={{ position: 'relative' }}>
          ...
          ></Box>
          {/* Text */}
          <Box sx={{ margin: '0 4rem 0 4rem' }}>
            <h1 style={{ color: '#BC27F6', width: '50%' }}>
        ...
        {/* Video */}
        <Box sx={{ height: '75rem', display:"flex", justifyContent:"center", alignItems:"center"}}>
          <svg
